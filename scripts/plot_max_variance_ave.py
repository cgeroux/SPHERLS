...
def main():
  ...
  for file in files:
    ...
    vU_U0MaxsTemp=math.fabs(radialProfile.fColumnValues[0][13]-radialProfile.fColumnValues[0][20])#used first value 
    for i in range(len(radialProfile.fColumnValues)-1):
      vU_U0MaxsTemp1=math.fabs(radialProfile.fColumnValues[i][13]-radialProfile.fColumnValues[i][20])
